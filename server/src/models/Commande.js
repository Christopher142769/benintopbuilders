...
const commandeSchema = new mongoose.Schema(
  {
    ...
    sousTotal: { type: Number, required: true },
    fraisService: { type: Number, required: true, default: 0 },
    commissionTaux: { type: Number, required: true, default: 0 },
    transactionHorsPlateforme: { type: Boolean, default: true },
    total: { type: Number, required: true },
    statut: { type: String, enum: COMMANDE_STATUS, default: 'demande_envoyee', index: true },
